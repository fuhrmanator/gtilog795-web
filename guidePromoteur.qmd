...
Le rôle du promoteur ne peut pas être pris par une étudiante ou un étudiant inscrit dans le cours, car c'est un conflit d'intérêts, surtout lorsqu'il s'agit d'évaluer le travail réalisé pour le promoteur.

- Si un promoteur propose des personnes de la communauté étudiante qui sont (ou qui ont été) des employées du promoteur, c'est un conflit d'intérêts potentiel et le promoteur doit l'indiquer dans la proposition pour la transparence. Il ne faut pas que les tâches d'évaluation du travail réalisé pour le promoteur soient confiées à ces personnes.
- Lorsqu'il s'agit d'un projet proposé par un club étudiant, il faut s'assurer que le rôle du promoteur est pris par une personne du club _qui n'est pas inscrite dans le cours_, pour la même raison que promoteur doit évaluer le travail réalisé. 
:::
