...
### Entente de partage de logiciel libre

::: {.callout-warning}
À partir de la soumission des projets pour l'automne 2023, le Département de génie logiciel et des TI **n'accepte plus de proposition de PFE avec une entente de confidentialité ou de cession des droits de PI**.
:::

Le seul cas où une entente peut exister est lorsqu'un Promoteur veut proposer un projet avec un **partage des droits en logiciel libre**, en spécifiant cette information sur le formulaire de proposition.
Les étudiants et étudiantes sont toujours libres de choisir un tel projet et leur code source leur appartiendra toujours, tandis qu'une license de logiciel libre permettra au Promoteur (et d'autres entités) un accès au code source selon la license choisie.

::: {.callout-tip collapse="true"}

## Cliquez ici pour voir des ressources pour choisir une license
- [*Choose a license*](https://choosealicense.com/): Ce site web propose un aperçu simplifié des licences open source populaires, en expliquant leurs caractéristiques clés, leurs restrictions et les cas d'utilisation recommandés. Il offre également un outil de choix de licence simple pour aider à affiner les options en fonction des besoins du projet.
- [*Open Source Initiative* (OSI)](https://opensource.org/): L'Open Source Initiative (OSI) est une organisation renommée dédiée à la promotion et à la protection des logiciels open source. Leur site web fournit une liste complète des licences approuvées par l'OSI, ainsi que des descriptions détaillées et des directives pour chaque licence. Les étudiants et étudiantes peuvent explorer cette ressource pour acquérir une meilleure compréhension des différentes options de licences.
- [*Creative Commons*](https://creativecommons.org/): Bien qu'elle soit principalement axée sur la licence de contenu, les licences Creative Commons peuvent être pertinentes pour les projets impliquant des composants autres que des logiciels, tels que la documentation, les œuvres d'art ou le multimédia. Creative Commons propose une gamme de licences avec des autorisations et des restrictions variables, qui peuvent être utiles pour les projets ayant différents besoins en termes de partage et d'attribution.
- [*GitHub's License Chooser*](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/licensing-a-repository): GitHub propose un outil de choix de licence dans le cadre de son processus de création de dépôt. Il présente une liste sélectionnée de licences open source et aide les utilisateurs à sélectionner une licence appropriée en fonction des besoins spécifiques de leur projet. Cet outil peut être particulièrement pratique pour les étudiants et étudiantes qui prévoient d'héberger leurs projets sur GitHub.
- [*Free Software Foundation*](https://www.fsf.org/): La *Free Software Foundation* (FSF) est une organisation axée sur la promotion et la défense du logiciel libre. Leur site web fournit des informations sur la licence publique générale GNU (GPL), l'une des licences open source les plus populaires. Les étudiants intéressés par les principes du logiciel libre peuvent explorer les ressources et les directives de la FSF.
- Conseils juridiques: Bien que les références ci-dessus puissent fournir des informations précieuses, il est important de noter que les décisions de licence peuvent avoir des implications juridiques. Pour les projets critiques ou si les étudiants ou les étudiantes ont des préoccupations juridiques spécifiques, il est recommandé de consulter des conseils juridiques de professionnels spécialisés dans les licences de logiciels et la propriété intellectuelle.
:::
...
1. [Document explicatif pour les PFE (2015)][DocumentExplicatif]
...
Souvent, il y a plus de propositions de projets que d'équipes disponibles, ce qui signifie qu'un certain nombre de projets ne sont pas acceptés faute d'intérêt suffisant.
...
Bref, la personne inscrite dans le cours de projet fin d'études est souvent "réticente aux risques".
Les risques comprennent le partage du code source (bien que ce soit un faible risque), les technologies niches, mais surtout les problèmes flous ou trop orientés recherche, etc.
Plus il y a de risques dans un projet, moins il sera populaire dans la communauté étudiante.
