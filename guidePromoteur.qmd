...
Il y a trois parties prenantes dans un PFE: la communauté étudiante inscrite dans le cours, le corps professoral affecté aux projets et les promoteurs (qui sont parfois des Compagnies).
...
- Selon l'entente de confidentialité de Type I (clause 9.1), les personnes dans une équipe doivent soumettre leur rapport à l'entreprise 3 semaines avant le délai (ce qui les pénalise d'une certaine manière par rapport à un projet où il n'y a pas cette contrainte).
Ainsi, il y a un risque que les étudiants et les étudiantes évitent ce genre de projet pour avoir plus de temps pour rédiger leur rapport.
...
- utiliser un langage vulgarisé pour l'étudiant et l'étudiante en dernière année dans un baccalauréat en ingénierie de génie logiciel et des technologies de l'information: si vous recyclez une description d'un projet provenant d'une demande de subvention (qui cherche à démontrer la complexité, la difficulté d'un problème) cela pourrait rendre le projet plus difficile à comprendre.
