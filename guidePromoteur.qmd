...
Le promoteur accepte de ne pas modifier les ententes (p.ex. au démarrage du projet), puisque l'étudiant et l'étudiant affecté au projet aurait fait son choix de projet selon les conditions des ententes.
...
- Les personnes inscrites dans le PFE sont également libres de choisir leurs projets candidats et peuvent simplement éviter les projets ayant les ententes de confidentialité ou de cession de droits (de Type III ou autre), surtout quand il n'y a pas de récompense financière pour leur travail.
Une proposition de projet avec trop de contraintes légales peut se trouver sans équipe.
:::
