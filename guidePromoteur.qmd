...
Chaque étudiant.e "vote" pour un nombre limité de projets parmi les propositions, spécifiant un ordre de préférence.
...
- utiliser un langage vulgarisé pour les étudiant.e.s en dernière année dans un baccalauréat en ingénierie de génie logiciel et des technologies de l'information: si vous recyclez une description d'un projet provenant d'une demande de subvention (qui cherche à démontrer la complexité, la difficulté d'un problème) cela pourrait rendre le projet plus difficile à comprendre.
- mentionner la forme des spécifications, p. ex. le *récits utilisateurs (user stories)*, le cas échéant, car ça peut rendre plus concret le problème.
- mettre en évidence la valeur du projet pour la société, l'économie, la sécurité, l'environnement, etc.: un projet très orienté recherche fondamentale, même s'il utilise les technologies modernes, est souvent évité par la plupart des étudiants.
