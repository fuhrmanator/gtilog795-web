...
-   Vous devez **créer un espace de collaboration** pour votre équipe.
    -   C. Fuhrman **recommande l'utilisation de Teams**, car le service informatique **(GUS) peut vous en créer un pour votre PFE** (vous devez mentionner que c'est demandé par C. Fuhrman).
    -   En plus, il y a un espace Office relié au Teams et c'est pratique pour le partage de documents (rapports, etc.).
    -   Vous pouvez aussi utiliser Slack ou Discord (pour clavardage) mais Google Drive n'est plus supporté par le STI pour les activités de premiers cycles.
-   Puisque la plupart des projets encadrés par C. Fuhrman impliquent du développement de logiciels libres, il faudrait **avoir un compte sur GitHub**. C. Fuhrman recommande de configurer votre compte sur GitHub avec votre adresse courriel de l'ÉTS. Cela vous permettra d'avoir des fonctionnalités supplémentaires grâce à GitHub for Education.
