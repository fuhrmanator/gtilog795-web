...
-   Pour la structure, il y a un bon résumé dans **1.3 Développement ou corps du travail** <https://www.etsmtl.ca/docs/etudes/Guides-gabarits/Documents/guide-redaction-projet-memoire-these#page=23>. Cependant, la structure est généralisée pour un rapport d'ingénierie. Il est normal d'avoir des questions à propos de comment appliquer cette structure à un sujet précis. **C'est important de communiquer avec moi tôt par rapport à la structure.**
...
-   Pour la conclusion, je vous recommande la structure suivante en **3 paragraphes**. Ceci est un extrait de la grille d'évaluation provenant du site [Accros](https://accros.etsmtl.ca/Rapports/index.asp):

+-------------------------------------------------------------------+------------------------------------------------------------------------------+-------------------------+
| Critères                                                          | Sous-critère 1                                                               | Sous-critère 2          |
+===================================================================+==============================================================================+=========================+
| **1^er^ paragraphe: Résumé du développement**                     | Respect des objectifs                                                        | Respect des normes      |
|                                                                   |                                                                              |                         |
...
|                                                                   |                                                                              | -   pertinence du cas   |
+-------------------------------------------------------------------+------------------------------------------------------------------------------+-------------------------+
| **2^e^ paragraphe: Rappel précis du mandat, de la problématique** | Démarche explicitée                                                          | Limites du projet       |
+-------------------------------------------------------------------+------------------------------------------------------------------------------+-------------------------+
| **3^e^ paragraphe: ouverture**                                    | Guider le lecteur vers l'action à entreprendre                               |                         |
+-------------------------------------------------------------------+------------------------------------------------------------------------------+-------------------------+
